...
lazy_static! {
    static ref DIAMOND_SIGHT_NOSE_OFFSET: Inches = Inches {
        magnitude: BigDecimal::from_str("3.6875").unwrap()
    };
    static ref GC4_POCKET_DEPTH: Inches = Inches {
        magnitude: BigDecimal::from_str("1.4").unwrap()
    };
    static ref GC4_CORNER_POCKET_WIDTH: Inches = Inches {
        magnitude: BigDecimal::from_str("4.5").unwrap()
    };
    static ref GC4_SIDE_POCKET_WIDTH: Inches = Inches {
        magnitude: BigDecimal::from_str("5").unwrap()
    };
    static ref CENTER_SPOT: Position = Position {
        x: Diamond::from("2"),
        y: Diamond::from("4")
    };
    static ref CENTER_OF_TOP_RIGHT_POCKET: Position = Position {
        x: Diamond::from("4"),
        y: Diamond::from("8")
    };
    static ref CENTER_OF_RIGHT_POCKET: Position = Position {
        x: Diamond::from("4"),
        y: Diamond::from("4")
    };
    static ref CENTER_OF_BOTTOM_RIGHT_POCKET: Position = Position {
        x: Diamond::from("4"),
        y: Diamond::from("0")
    };
    static ref CENTER_OF_BOTTOM_LEFT_POCKET: Position = Position {
        x: Diamond::from("0"),
        y: Diamond::from("0")
    };
    static ref CENTER_OF_LEFT_POCKET: Position = Position {
        x: Diamond::from("0"),
        y: Diamond::from("4")
    };
    static ref CENTER_OF_TOP_LEFT_POCKET: Position = Position {
        x: Diamond::from("0"),
        y: Diamond::from("8")
    };
}
