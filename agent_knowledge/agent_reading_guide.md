...
- `whitepapers/collision_of_two_spinning_billiard_balls_and_the_role_of_table_friction.pdf` — Collision of two spinning billiard balls and the role of table [code, docs]
...
- `whitepapers/tp_3_7_effective_target_sizes_for_fast_shots_into_a_side_pocket_at_different_angles.pdf` — TP 3.7 - Effective Target Sizes For Fast Shots Into A Side Pocket At Different Angles [code, docs]
- `whitepapers/tp_3_8_effective_target_sizes_for_fast_shots_into_a_corner_pocket_at_different_angles.pdf` — TP 3.8 - Effective Target Sizes For Fast Shots Into A Corner Pocket At Different Angles [code, docs]
- `whitepapers/tp_4_2_center_of_percussion_of_the_cue_ball.pdf` — TP 4.2 - Center of percussion of the cue ball [code, docs]
- `whitepapers/tp_a_24_the_effects_of_follow_and_draw_on_throw_and_ob_swerve.pdf` — TP A.24 - The effects of follow and draw on throw [code, docs]
- `whitepapers/tp_a_4_post_impact_cue_ball_trajectory_for_any_cut_angle_speed_and_spin.pdf` — TP A.4 - Post-impact cue ball trajectory for any cut angle, speed, and spin [code, docs]
- `whitepapers/tp_b_1_squirt_angle_pivot_length_and_tip_size.pdf` — TP B.1 - Squirt angle, pivot length, and tip shape [code]
- `whitepapers/tp_b_2_rolling_resistance_spin_resistance_and_ball_turn.pdf` — TP B.2 - Rolling resistance, spin resistance, and "ball turn [code, docs]
- `whitepapers/tp_b_5_rolling_cb_direct_hit_hop_and_ball_travel_distances.pdf` — TP B.5 - Rolling CB, direct-hit hop and ball travel distances [code]
- `whitepapers/tp_b_6_cue_ball_table_lengths_of_travel_for_different_speeds_accounting_for_rail_rebound_and_drag_losses.pdf` — TP B.6 - CB table lengths of travel for different speeds [code]
- `whitepapers/30_degree_rule_for_caroms.html` — 30-Degree Rule for Caroms - December 2009 [docs]
...
- `whitepapers/bank_shot_reference_tracks.pdf` — Bank Shot Reference Tracks [docs]
- `whitepapers/billiard_university_bu_part_iv_table_difficulty.pdf` — Billiard University BU Part Iv Table Difficulty [docs]
- `whitepapers/billiards_on_the_big_screen_the_hustler.pdf` — Billiards on the Big Screen - The Hustler [docs]
...
- `whitepapers/corey_deuel_s_famous_draw_shot.pdf` — Corey Deuel S Famous Draw Shot [docs]
- `whitepapers/draw_shot_physics_part_i_basics.pdf` — Draw Shot Physics - Part I: basics [docs]
- `whitepapers/draw_shot_physic_part_iii_spin_ratio.pdf` — Draw Shot Physics - Part III: spin ratio [docs]
...
- `whitepapers/follow_control.pdf` — Follow Control [docs]
- `whitepapers/frozen_proposition_shot.pdf` — Frozen Proposition Shot [docs]
- `whitepapers/golden_break.pdf` — Golden Break [docs]
- `whitepapers/just_how_big_are_the_pockets_anyway_part_i.pdf` — Just How Big are the Pockets, Anyway? - Part I [docs]
- `whitepapers/magic_spot_kicks.pdf` — Magic Spot Kicks [docs]
...
- `whitepapers/tp_7_3_ball_rail_interaction_and_the_effects_on_vertical_plane_spin.pdf` — TP 7.3 - Ball-rail interaction and the effects on vertical plane spin [docs]
- `whitepapers/tp_a_26_the_amount_of_sidespin_required_for_gearing_outside_english.pdf` — TP A.26 - The Amount Of Sidespin Required For Gearing Outside English [docs]
- `whitepapers/tp_a_27_spin_transfer.pdf` — TP A.27 - Spin Transfer [docs]
- `whitepapers/tp_a_8_the_effects_of_sidespin_on_the_30_degree_rule.pdf` — TP A.8 - The effects of English on the 30° rule [docs]
- `whitepapers/tp_b_15_pocket_geometry_calculations.pdf` — TP B.15 - Pocket geometry calculations [docs]
- `whitepapers/tp_b_29_simulation_of_a_cb_striking_two_frozen_obs_along_their_line_of_centers.pdf` — TP B.29 - Simulation of a CB striking two frozen OBs along their line of centers [docs]
- `whitepapers/tp_b_8_draw_shot_physics.pdf` — TP B.8 - Draw shot physics [docs]
- `whitepapers/tp_4_1_distance_required_for_stun_and_normal_roll_to_develop.pdf` — TP_4-1 [docs]
...
- `whitepapers/tp_b_1_squirt_angle_pivot_length_and_tip_size.pdf` — TP B.1 - Squirt angle, pivot length, and tip shape [starter | code-cited | formula-lines:40]
...
- `whitepapers/tp_a_24_the_effects_of_follow_and_draw_on_throw_and_ob_swerve.pdf` — TP A.24 - The effects of follow and draw on throw [starter | code-cited | formula-lines:40]
- `whitepapers/tp_3_8_effective_target_sizes_for_fast_shots_into_a_corner_pocket_at_different_angles.pdf` — TP 3.8 - Effective Target Sizes For Fast Shots Into A Corner Pocket At Different Angles [starter | code-cited | formula-lines:40]
...
- `whitepapers/tp_3_6_effective_target_sizes_for_slow_shots_into_a_corner_pocket_at_different_angles.pdf` — TP 3.6 - Effective Target Sizes For Slow Shots Into A Corner Pocket At Different Angles [starter | code-cited | formula-lines:40]
- `whitepapers/tp_3_5_effective_target_sizes_for_slow_shots_into_a_side_pocket_at_different_angles.pdf` — TP 3.5 - Effective Target Sizes For Slow Shots Into A Side Pocket At Different Angles [starter | code-cited | formula-lines:40]
...
- `whitepapers/follow_control.pdf` — Follow Control [doc-cited]
- `whitepapers/corey_deuel_s_famous_draw_shot.pdf` — Corey Deuel S Famous Draw Shot [doc-cited]
...
- `whitepapers/a_theoretical_analysis_of_billiard_ball_dynamics_under_cushion_impacts.pdf` — A Theoretical Analysis Of Billiard Ball Dynamics Under Cushion Impacts [starter | doc-cited | formula-lines:40]
- `whitepapers/rolling_motion_of_a_ball_spinning_about_a_near_vertical_axis.pdf` — Rolling motion of a ball spinning about a near vertical axis [starter | code-cited | formula-lines:37]
- `whitepapers/the_physics_of_billiards.html` — The Physics Of Billiards [starter | code-cited | formula-lines:28]
- `whitepapers/pool_and_billiards_physics_principles_by_coriolis_and_others.pdf` — Pool and Billiards Physics Principles by Coriolis and Others [starter | code-cited | formula-lines:24]
...
- ... 222 more in `whitepapers_index.jsonl`
...
- ... 15 more in `whitepapers_index.jsonl`
...
- `whitepapers/tp_b_29_simulation_of_a_cb_striking_two_frozen_obs_along_their_line_of_centers.pdf` — TP B.29 - Simulation of a CB striking two frozen OBs along their line of centers [doc-cited | formula-lines:26]
...
- `whitepapers/application_of_high_speed_imaging_to_determine_the_dynamics_of_billiards.pdf` — Application of high-speed imaging to determine the dynamics of billiards [formula-lines:14]
- `whitepapers/design_fabrication_and_implementation_of_jump_cue_testing_machine.pdf` — Design, Fabrication, and Implementation of Jump-Cue Testing Machine [formula-lines:9]
- ... 5 more in `whitepapers_index.jsonl`
...
- `whitepapers/luckily_dimitri_never_inhaled.pdf` — Luckily Dimitri Never Inhaled
- `whitepapers/jared_s_ride_isn_t_fly_but_the_steering_s_perfect.pdf` — Jared S Ride Isn T Fly But The Steering S Perfect
- `whitepapers/gadget_keeps_suspension_even.pdf` — Gadget Keeps Suspension Even
- `whitepapers/gadget_cares_for_your_best_friend.pdf` — Gadget Cares For Your Best Friend
- `whitepapers/christina_and_the_dangerous_duck_slalom.pdf` — Christina And The Dangerous Duck Slalom
- `whitepapers/additional_parts_required_duct_tape_and_baling_wire.pdf` — Additional Parts Required Duct Tape And Baling Wire
